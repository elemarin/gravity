...
export const PARTS_CATALOG: RocketPart[] = [
  ...
  },
  {
    ...
    fuelCapacity: 0,
    unlockedByDefault: false,
    description: 'Compact gimballing core — heavy-lifter thrust in a tidy package.',
    icon: '⊻',
    color: 0x5fb6a8,
    accent: 0xffd54a,
    finish: 'metallic',
  ...
  },
  {
    ...
    fuelCapacity: 760,
    unlockedByDefault: false,
    description: 'Big paneled tank that bridges the gap to interplanetary stages.',
    icon: '⬚',
    color: 0xffc36b,
    accent: 0x2b5cff,
    style: 'panelled',
  ...
  },
  {
    ...
    fuelCapacity: 0,
    unlockedByDefault: false,
    description: 'Glass observation pod — light crew cabin with a panoramic dome.',
    icon: '◍',
    color: 0xbfe6ff,
    accent: 0x1fd9ff,
    style: 'panelled',
  ...
  },
  {
    ...
    fuelCapacity: 620,
    unlockedByDefault: false,
    description: 'Skycrane descent stage that lowers a rover gently onto rough ground.',
    icon: '🚙',
    color: 0xd8c08a,
    accent: 0xff7a3c,
    finish: 'satin',
